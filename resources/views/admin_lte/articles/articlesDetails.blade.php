...
<div class="content-wrapper" style="min-height: 1301.28px;">
                  ...
                  <thead>
                    <tr>
                     ...
                     {{-- @if(!empty($article)) --}}
                      ...
                      <td>{{$article_details->description}}</td>
                      <td>{{$article_details->image}}</td>
                        <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                              <a class="dropdown-item" href="{{route('article.edit', ['id'=>$article_details->id])}}">Edit</a>
                              <a class="dropdown-item" href="{{route('article.delete', ['id'=>$article_details->id])}}">Delete</a>
                            </div>
                     </td>
                    </tr>
                    {{-- @endif --}}
  ...
  <body>
    <x-App-Layouts title="Articles Detail">
