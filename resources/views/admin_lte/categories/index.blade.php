                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>{{ Helper::getCategoryId($category->parent_id) }}</td>
                        <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                              <a class="dropdown-item" href="{{route('category.edit', ['id'=>$category->id])}}">Edit</a>
                              <a class="dropdown-item" href="{{route('category.delete', ['id'=>$category->id])}}">Delete</a>
                              <a class="dropdown-item" href="{{route('category.details', ['id'=>$category->id])}}">Details</a>
                            </div>
                         </td>
                    </tr>
                    @endforeach
...
<body>
    <x-App-Layouts title="Categories Page">
