...
<div class="content-wrapper" style="min-height: 1301.28px;">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    @if(!is_null($project->article_id))
                     <td> <a href= "{{route('article-detail', ['article'=>Helper::getArticleSlug($project->article_id)])}}">
                     {{Helper::getArticleName($project->article_id)}}</a>
                    </td>
                @endif
                        <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                              ...
                              <a class="dropdown-item" href="{{route('project.delete', ['id'=>$project->id])}}">Delete</a>
                              <a class="dropdown-item" href="{{route('project.details', ['id'=>$project->id])}}">Detail</a>
                            </div>
                        </td>
                       </tr>
                       @endforeach
  ...
  <body>
    <x-App-Layouts title="Projects Page">
