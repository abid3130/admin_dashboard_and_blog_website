...
<div class="content-wrapper" style="min-height: 1301.28px;">
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    <tr>
                      <td>{{$comment_details->name}}</td>
                      <td>{{$comment_details->comment}}</td>
                      <td>{{$comment_details->website }}</td>
                      <td>{{$comment_details->email }}</td>
                      <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                              <a class="dropdown-item" href="{{route('comment.edit', ['id'=>$comment_details->id])}}">Edit</a>
                              <a class="dropdown-item" href="{{route('comment.delete', ['id'=>$comment_details->id])}}">Delete</a>
                            </div>
                        </td>
                    </tr>
                    @endif
  ...
  <body>
    <x-App-Layouts title="Comments Detail">
